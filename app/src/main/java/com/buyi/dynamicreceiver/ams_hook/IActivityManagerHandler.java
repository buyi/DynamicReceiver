package com.buyi.dynamicreceiver.ams_hook;
...
import com.buyi.dynamicreceiver.StubActivity;
...
/* package */ class IActivityManagerHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if ("startActivity".equals(method.getName())) {
            ...
            String stubPackage = "com.buyi.dynamicreceiver";//UPFApplication.getContext().getPackageName();
